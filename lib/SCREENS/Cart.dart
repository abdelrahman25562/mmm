            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Container(
                    ...
                    child: InkWell(
                      child: RaisedButton(onPressed: (){Navigator.push(context, MaterialPageRoute(builder: (context)=>Checkout()));},color: Color(0xffEA9307),child: Text('Check out',style: TextStyle(color: Colors.white,fontSize: 22.0),),shape: RoundedRectangleBorder(
